...
class BusinessRuleViolation(ProblemDetails):
    type: Literal["https://problems-registry.smartbear.com/business-rule-violation"] = (
        Field(
...
class MissingBodyProperty(ProblemDetails):
    type: Literal["https://problems-registry.smartbear.com/missing-body-property"] = (
        Field(
...
class MissingRequestHeader(ProblemDetails):
    type: Literal["https://problems-registry.smartbear.com/missing-request-header"] = (
        Field(
...
class ServiceUnavailable(ProblemDetails):
    type: Literal["https://problems-registry.smartbear.com/service-unavailable"] = (
        Field(
